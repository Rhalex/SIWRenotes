        ...
        <div class="text-center">
          ...
          <input type="submit" value="Applica">
            ...
            <div class="panel panel-default">	
              ...
              <div class="panel-heading"><a href="ViewMyBundle"><strong>I miei bundle</strong></a><i class="fa fa-link fa-1x"></i></div>
              ...
              <div class="panel-heading"><a href="CreateBundle"><font color="00A000"><strong>Crea Bundle</strong></font></a><i class="fa fa-link fa-1x"></i></div>
            </div>
                      ...
                      <form class="form" action="ModifyUserServlet" method="POST" id="registrationForm">
					   ...
					   <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="password" class="form-control" name="password" id="password" placeholder="password" oninput="checkModifyPwd()">
                        ...
                        <a href="chart.jsp" class="fas fa-chart-pie"></a>
                        
                        <div class="form-group">
                             <div class="col-xs-12">
                                  <br>
                                  <button class="btn btn-lg btn-success pull-right" type="submit" id="applicaModifica" disabled="disabled"><i class="glyphicon glyphicon-ok-sign"></i> Applica modifiche</button>
                             </div>
                        </div>
                    </form>
  ...
  function logOut()
	...
	/* 	var auth2 = gapi.auth2.getAuthInstance();
	    ...
	    $.ajax({
	        ...
	        {
	           window.location.replace("http://localhost:8080/it.unical.ingsw.siw.renotes/index.jsp");
	        },
	        error: function(){}
	    });
	}
